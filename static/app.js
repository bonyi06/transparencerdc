...
function mGeo(){
  ...
  return `<div class="phead"><div class="eyebrow">Territoire</div><h1>Géographie de l'extraction</h1><p data-edit="intros.geo">${esc(C.intros.geo)}</p><p>Choisissez une <b>couche</b> ci-dessous (recettes, paiements infranationaux, cahiers de charge, permis du cadastre…), puis l'<b>année</b>, la <b>vue</b> et le <b>niveau</b> (national / province / territoire / ETD). Sur les couches ETD et Dotations OS DOT, chaque bénéficiaire apparaît en <b>point géolocalisé</b>. Survolez, zoomez, cliquez.</p>
    ...
    <p style="font-size:12.5px;color:var(--ink-soft);margin-top:4px"><b>Note sur les couches « Cahiers de charge — 2021 (résumé mai 2022) » :</b> ces deux couches proviennent d'un document distinct (« Résumé des cahiers des charges des entreprises minières », mai 2022) et ne couvrent que les 14 entreprises de la feuille source « HAUT-KATANGA 2021-2025 » — pas l'ensemble du pays. Elles se distinguent des couches « Cahiers de charge (nb, statut CPI) » et « (dépenses sociales, $) », qui viennent des annexes officielles des Rapports ITIE (2022-2023) et comptent les <i>cahiers</i> par statut d'approbation, une base différente. Détail entreprise par entreprise et projet par projet dans la rubrique « Dépenses sociales et environnementales ».</p></div>
